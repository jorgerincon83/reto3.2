...
* The following dependencies are not known to work with Spring Native: 'Rest Repositories, MariaDB Driver'. As a result, your application may not work as expected.
* The original package name 'co.usa.reto3.4.5.reto3.4.5' is invalid and this project uses 'co.usa.reto345.reto345' instead.
...
```
$ docker run --rm -p 8080:8080 reto3.4.5:0.0.1-SNAPSHOT
```
